...
use PhpUnit\Util\TestDox\ResultPrinter\Html as TestDoxHtml;
...
class PHPUnit_TextUI_TestRunner extends BaseTestRunner
{
    ...
    /**
     * @var \PhpUnit\Runner\TestSuiteLoader
     */
    ...
    /**
     * @param \PhpUnit\Runner\TestSuiteLoader $loader
     * @param PHP_CodeCoverage_Filter         $filter
     * @since Method available since Release 3.4.0
     */
    public function __construct(TestSuiteLoader $loader = null, PHP_CodeCoverage_Filter $filter = null)
    {
        if ($filter === null) {
    ...
    private function processSuiteFilters(TestSuite $suite, array $arguments)
    {
        ...
        if (!empty($arguments['excludeGroups'])) {
            $filterFactory->addFilter(
                new ReflectionClass('PhpUnit\\Runner\\Filter\\Group\\ExcludeIterator'),
